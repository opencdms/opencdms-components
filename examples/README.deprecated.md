...
Run `ng new project-name --createApplication=false`
...
6. Import and add `CUSTOM_ELEMENTS_SCHEMA` to tell allow you serve and test your app on the browser while building out a web component
...
At this point, your web component should work in a basic web page.
